...
Queremos ver si el sexo es un factor importante a la hora de predecir si una persona es alcoholica. Calculamos las cantidades de alcoholicos por sexo, como no hay la misma cantidad de hombres y mujeres en el dataset, calculamos la proporción de alcoholicos para poder compararlas.
```{r plots}
...
boxplot(age ~ DRK_YN, data=data, 
        ...
        ylim = c(10, 90))
```
Se puede ver que hay cierta diferencia, considerando que hay casi la misma cantidad de alcoholicos y no alcoholicos en el dataset, se puede ver 
...
valores_depth = c(2,5,6,7,8,9,10,15,20)
valores_split = c(5,10,50,100,500,1000,5000,10000)
valores_bucket = c(5,10,20,50,100,500,1000,5000,10000)
